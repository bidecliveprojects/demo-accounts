	...
	<div class="boking-wrp dp_sdw">
	    <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                {{CommonHelper::displayPageTitle('View Purchase Invoice List')}}
            </div>
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 text-right">
                <a href="{{ route('purchase-invoice.create') }}" class="btn btn-success btn-xs"><span></span> Create New</a>
            </div>
        </div>
        <form id="list_data" method="get" action="{{ route('purchase-invoice.index') }}">
            <div class="row">
                    ...
                    <table class="table table-bordered table-striped table-condensed">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center">P.I.No.</th>
                                <th class="text-center">P.I.Date</th>
