	...
	<div class="boking-wrp dp_sdw">
	    <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                {{CommonHelper::displayPageTitle('Add New Student')}}
            </div>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                            ...
                            <input type="text" name="registration_no" @if(Session::get('registration_no_option') == 1) readonly @endif id="registration_no" value="" class="form-control" />
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                            ...
                            id="date_of_admission" value="{{old('date_of_admission') ?? date('Y-m-d')}}" />
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                            ...
                            id="student_name" value="{{old('student_name')}}" />
                            @error('student_name')
                                <div class="text-sm text-danger text-red-600">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                            ...
                            id="father_qualification" value="{{old('father_qualification')}}" />
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                            ...
                            id="mother_qualification" value="{{old('mother_qualification')}}" />
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                            ...
                            id="parent_email" value="{{old('parent_email')}}" />
                            @error('parent_email')
                                <div class="text-sm text-danger text-red-600">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                            ...
                            id="home_address" value="{{old('home_address')}}" />
                            @error('home_address')
                                <div class="text-sm text-danger text-red-600">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                            ...
                            id="specify_any_health_problem_medication" value="{{old('specify_any_health_problem_medication')}}" />
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                            ...
                            id="concession_fees" value="{{old('concession_fees')}}" />
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                            <label>Father Guardian Cnic Front <span class="text-danger">*</span></label>
