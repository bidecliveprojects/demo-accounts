...
<head>
    ...
    <title>Login Alert - {{ env('APP_NAME') }}</title>
</head>
...
<body>
    ...
    <h2 style="background-color: #f0f0f0; padding: 10px; display: inline-block;">{{ $user->verification_code }}</h2>

    <p>This OTP is valid for {{ $duartion }} minutes</p>
