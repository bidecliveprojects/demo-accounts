...
<div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-right">
        ...
        @if($paymentDetail->status == 1 && $paymentDetail->pv_status == 2 && $paymentDetail->entry_option == 1)
            <button class="btn btn-xs btn-danger" onclick="reverseFinanceVoucher('1', '<?php echo $paymentDetail->id?>', '<?php echo $paymentDetail->status?>', '<?php echo $paymentDetail->pv_status?>')">Reverse Voucher</button>&nbsp;
        @endif
    </div>
</div>
