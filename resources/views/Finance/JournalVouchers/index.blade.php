	...
	<div class="boking-wrp dp_sdw finance-page-card">
	    <div class="row finance-page-head">
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                ...
                <p class="finance-page-lead text-muted hidden-xs">Filter by voucher type, status, and date range.</p>
            </div>
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 text-right finance-page-actions">
                <a href="{{ route('journalvouchers.create') }}" class="btn btn-success btn-sm"><i class="fa fa-plus" aria-hidden="true"></i> New journal</a>
            </div>
        </div>
        <form id="list_data" method="get" action="{{ route('journalvouchers.index') }}" class="finance-filter-form">
                ...
                <table class="table table-bordered table-striped table-condensed table-hover finance-data-table">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center finance-col-narrow">J.V.No.</th>
                            <th class="text-center finance-col-narrow">J.V.Date</th>
                            <th class="text-center finance-col-narrow">Slip No</th>
