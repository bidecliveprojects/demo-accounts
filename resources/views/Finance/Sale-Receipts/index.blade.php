	...
	<div class="boking-wrp dp_sdw finance-page-card">
	    <div class="row finance-page-head">
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                {{ CommonHelper::displayPageTitle('View Sale Receipt Voucher List') }}
                <p class="finance-page-lead text-muted hidden-xs">Filter sale receipts by type, status, and dates.</p>
            </div>
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 text-right finance-page-actions">
                <a href="{{ route('sale-receipts.create') }}" class="btn btn-success btn-sm"><i class="fa fa-plus" aria-hidden="true"></i> New receipt</a>
            </div>
        </div>
        <form id="list_data" method="get" action="{{ route('sale-receipts.index') }}" class="finance-filter-form">
