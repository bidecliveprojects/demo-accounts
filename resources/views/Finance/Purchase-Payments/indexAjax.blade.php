...
@endphp
@foreach($purchasePayments as $key => $row)
    <tr>
        ...
        <td class="text-center">
            <div class="dropdown">
                ...
                <ul class="dropdown-menu">
                    <li><a onclick="showDetailModelOneParamerter('finance/purchase-payments/show','<?php echo $row->id;?>','View Payment Detail')"><span class="glyphicon glyphicon-eye-open"></span> View</a></li>
                </ul>
            </div>
        </td>
    </tr>
