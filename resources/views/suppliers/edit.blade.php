        ...
        <div class="boking-wrp dp_sdw">
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    {{ CommonHelper::displayPageTitle('Edit Supplier Detail') }}
                </div>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="row">
                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                ...
                                <input type="hidden" name="supplier_acc_id" id="supplier_acc_id" value="{{$supplier->acc_id}}" />
                                <input type="hidden" name="old_acc_id" id="old_acc_id" value="{{$supplier->parent_code}}" />
                                <select name="acc_id" id="acc_id" class="form-control">
                                    @foreach ($chartOfAccountList as $coalRow)
                                        <option value="{{ $coalRow->code }}"
                                            {{ $supplier->parent_code == $coalRow->code ? 'selected' : '' }}>
                                            {{ $coalRow->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                ...
                                <input type="text" name="ntn_no"
                                    ...
                                    value="{{ old('ntn_no', $supplier->ntn_no) }}" />
                                @error('ntn_no')
                                    <div class="text-sm text-danger text-red-600">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                ...
                                <input type="text" name="strn_no"
                                    ...
                                    value="{{ old('strn_no', $supplier->strn_no) }}" />
                                @error('strn_no')
                                    <div class="text-sm text-danger text-red-600">{{ $message }}</div>
                                @enderror
                            </div>
                                ...
                                <select name="city_id" id="city_id" class="form-control">
                                    @foreach ($cities as $cRow)
                                        <option value="{{ $cRow['id'] }}"
                                            {{ $supplier->city_id == $cRow['id'] ? 'selected' : '' }}>
                                            {{ $cRow['city_name'] }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="row">
                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                ...
                                <input type="text" name="cnic_no"
                                    ...
                                    value="{{ old('cnic_no', $supplier->cnic_no) }}" />
                                @error('cnic_no')
                                    <div class="text-sm text-danger text-red-600">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                ...
                                <input type="text" name="phone_no"
                                    ...
                                    value="{{ old('phone_no', $supplier->phone_no) }}" />
                                @error('phone_no')
                                    <div class="text-sm text-danger text-red-600">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                ...
                                <input type="text" name="email_address"
                                    ...
                                    id="email_address" value="{{ old('email_address', $supplier->email_address) }}" />
                                @error('email_address')
                                    <div class="text-sm text-danger text-red-600">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                ...
                                <input type="text" name="account_title"
                                    ...
                                    id="account_title" value="{{ old('account_title', $supplier->account_title) }}" />
                                @error('account_title')
                                    <div class="text-sm text-danger text-red-600">{{ $message }}</div>
                                @enderror
                            </div>
