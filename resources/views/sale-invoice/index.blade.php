	...
	<div class="boking-wrp dp_sdw">
	    <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                {{CommonHelper::displayPageTitle('View Sale Invoice List')}}
            </div>
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 text-right">
                <a href="{{ route('sale-invoice.create') }}" class="btn btn-success btn-xs"><span></span> Create New</a>
            </div>
        </div>
        <form id="list_data" method="get" action="{{ route('sale-invoice.index') }}">
            <div class="row">
                    ...
                    <table class="table table-bordered table-striped table-condensed">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center">S.I.No.</th>
                                <th class="text-center">S.I.Date</th>
