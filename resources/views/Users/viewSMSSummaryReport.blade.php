...
@section('content')
	...
	<div class="row">
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			<div style="float:right;">
				<button class="btn btn-sm btn-info" onclick="checkPrintStatus('printViewSMSSummaryReportList','1')">
		...
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			<div class="well_N">
				<div class="boking-wrp dp_sdw">
					<div class="row">
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							<?php echo CommonFacades::displayViewPageTitle('View SMS Summary Report');?>
						</div>
					</div>
					<div class="lineHeight">&nbsp;</div>
					<input type="hidden" name="functionName" id="functionName" value="udc/filterViewSMSSummaryReportList" readonly="readonly" class="form-control" />
					<input type="hidden" name="tbodyId" id="tbodyId" value="filterViewSMSSummaryReportList" readonly="readonly" class="form-control" />
					...
					<input type="hidden" name="filterType" id="filterType" value="filterViewSMSSummaryReportList" readonly="readonly" class="form-control" />
					<div class="row">
						<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
							<label>Mobile No's</label>
							<select  name="filterMobileNo" id="filterMobileNo" class="form-control">
								<option value="">Select Mobile No</option>
								<?php foreach($getMobileNoList as $gmnlRow){?>
									<option value="<?php echo $gmnlRow->mobile_no?>"><?php echo $gmnlRow->mobile_no?></option>
								<?php }?>
							</select>
						</div>
					...
					<div class="lineHeight">&nbsp;</div>
					<div id="printViewSMSSummaryReportList">
						<div class="row">
							<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
								...
								<div class="row" style="overflow-y: scroll;">
									<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
										<div class="table-responsive wrapper">
											<table class="table table-bordered customTableTwo" id="viewSMSSummaryReportList">
												<thead>
													<tr>
														<th class="text-center">S.No</th>
														<th class="text-center">Mobile No</th>
														<th class="text-center">SMS Service Provider</th>
														<th class="text-center">Masking Name</th>
														<th class="text-center">Status</th>
														<th class="text-center">Date</th>
														<th class="text-center">Time</th>
														<th class="text-center">Message Detail</th>
														<th class="text-center">Response Detail</th>
													</tr>
												</thead>
												<tbody id="filterViewSMSSummaryReportList"></tbody>
											</table>
										</div>
									</div>
								</div>
    ...
    <script>
		...
		function checkCsvStatus(){
			exportView('viewSMSSummaryReportList','','1');
		}
	</script>
@endsection