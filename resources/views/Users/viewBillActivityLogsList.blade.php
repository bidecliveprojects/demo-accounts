...
$billingLogs = DB::table('billing_logs')->select('billing_logs.activity')->distinct('activity')->get();
		...
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			<div class="well_N">
				<div class="boking-wrp dp_sdw">
					<div class="row">
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							<?php echo CommonFacades::displayViewPageTitle('View Users  Billing Activity Logs Detail List');?>
						</div>
					</div>
					<div class="lineHeight">&nbsp;</div>
					<input type="hidden" name="functionName" id="functionName" value="udc/filterActivityBillingLogsList" readonly="readonly" class="form-control" />
					<input type="hidden" name="tbodyId" id="tbodyId" value="filterActivityBillingLogsList" readonly="readonly" class="form-control" />
					...
					<input type="hidden" name="filterType" id="filterType" value="filterActivityBillingLogsList" readonly="readonly" class="form-control" />
									...
									<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
										<div class="table-responsive wrapper">
											<table class="table table-bordered customTableTwo" id="bookingList">
												...
												<tbody id="filterActivityBillingLogsList"></tbody>
											</table>
										</div>
									</div>
								</div>
