...
<div class="well_N">
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-right">
            <?php echo CommonHelper::displayPrintButtonInBlade('PrintPayableDetail', '', '1');?>
            <button id="pdf" onclick="generatePDFFile('PrintPayableDetail','View Payable Report')"
                class="btn btn-sm btn-success">TO PDF</button>
        </div>
    </div>
    <div class="lineHeight">&nbsp;</div>
    <form id="list_data" method="get" action="{{ route('reports.viewPayableReport') }}">
        <div class="row">
