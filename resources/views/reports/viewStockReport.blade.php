...
<div class="well_N">
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-right">
            <?php echo CommonHelper::displayPrintButtonInBlade('PrintStockReportList', '', '1');?>
            <button id="pdf" onclick="generatePDFFile('PrintStockReportList','View Stock Report List')"
                class="btn btn-sm btn-success">TO PDF</button>
        </div>
    </div>
    <div class="lineHeight">&nbsp;</div>
    <form id="list_data" method="get" action="{{ route('reports.viewStockReport') }}">
        <div class="row">
            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                ...
                <input type="hidden" value="{{Session::get('company_location_id')}}" id="company_location_id"
                    ...
                    <select name="filter_product_variant_id" id="filter_product_variant_id" class="form-control">
