	...
	<div class="boking-wrp dp_sdw">
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                {{CommonHelper::displayPageTitle('Edit City Detail')}}
            </div>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                            ...
                            <select name="state_id" id="state_id" class="form-control select2">
                                @foreach (CommonHelper::get_all_states(1) as $row)
                                    <option value="{{ $row->id }}" @if($city->state_id == $row->id) selected @endif>{{ $row->state_name }}</option>
                                @endforeach
                            </select>
                            @error('state_id')
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                            ...
                            id="city_name" value="{{ $city->city_name }}" />
                            @error('city_name')
                                <div class="text-sm text-danger text-red-600">{{ $message }}</div>
                            @enderror
                        </div>
