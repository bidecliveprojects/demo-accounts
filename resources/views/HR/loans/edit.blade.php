    ...
    <div class="boking-wrp dp_sdw hr-page-card">
        <div class="row hr-employees-form-head">
            <div class="col-lg-7 col-md-7 col-sm-12 col-xs-12">
                {{ CommonHelper::displayPageTitle('Edit Employee Loan') }}
                <p class="hr-employees-form-lead text-muted hidden-xs">Update loan details for this employee.</p>
            </div>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            ...
                            <input type="number" name="amount" id="amount" value="{{ old('amount', $loan->amount) }}" class="form-control" step="any" />
                            @error('amount')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            ...
                            <input type="number" name="per_month_deduction" id="per_month_deduction" value="{{ old('per_month_deduction', $loan->per_month_deduction) }}" class="form-control" step="any" />
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <textarea name="description" id="description" class="form-control" rows="3">{{ old('description', $loan->description) }}</textarea>
                            @error('description')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="hr-form-actions row">
                        <div class="col-xs-12 text-right">
                            ...
                            <button type="submit" class="btn btn-success btn-sm"><i class="fa fa-save" aria-hidden="true"></i> Update loan</button>
                        </div>
                    </div>
                </div>
            </form>
